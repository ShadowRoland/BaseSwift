...
extension BaseViewController {
    ...
    fileprivate func stateMachine(_ stateMachine: SRStateMachine, didFireBase event: Event) {
        switch event.option {
    ...
    fileprivate func stateMachine(_ stateMachine: SRStateMachine, didEndBase event: Event) {
        switch event.option {
        case .openWebpage:
