...
public protocol SRVideoPlayerDelegate: class {
...
extension SRVideoPlayerDelegate {
    func player(didFailLoading player: SRVideoPlayer!, error: Error?) { }
    func player(isConnectingWwan player: SRVideoPlayer!) -> Bool { return true }
    func player(controlViewsDidShow player: SRVideoPlayer!) {}
    func player(controlViewsWillHide player: SRVideoPlayer!, animated: Bool) {}
    func player(updateStatusBar player: SRVideoPlayer!, isStatusBarHidden: Bool) {}
}
...
SRAssetResourceLoaderTaskDelegate {
    ...
    func showControlViews() {
        ...
        if #available(iOS 9.0, *) {
            delegate?.player(updateStatusBar: self, isStatusBarHidden: isFullScreen)
        } else {
    ...
    func hideControlViews(_ animated: Bool) {
        ...
        if !animated {
            ...
            UIView.animate(withDuration: 0.5, animations: { [weak self] in
                ...
                if #available(iOS 9.0, *) {
                    strongSelf.delegate?.player(updateStatusBar: strongSelf,
                                                isStatusBarHidden: strongSelf.isFullScreen)
                } else {
                    UIApplication.shared.isStatusBarHidden = strongSelf.isFullScreen
                }
