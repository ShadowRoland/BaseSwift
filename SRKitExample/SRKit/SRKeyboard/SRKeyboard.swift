...
public let Keyboard = SRKeyboard.shared

public class SRKeyboard: NSObject {
    ...
    public class var shared: SRKeyboard {
        if sharedInstance == nil {
            sharedInstance = SRKeyboard()
            let center = NotificationCenter.default as NotificationCenter
    ...
    private static var sharedInstance: SRKeyboard!
